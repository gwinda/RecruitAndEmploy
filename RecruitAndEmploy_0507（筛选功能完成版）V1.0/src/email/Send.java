...
public class Send {
   ...
   // String receiveMailAccount = "m15219605797@163.com";
    ...
    /*public static void main(String[] args) throws Exception {*/
        ...
        MimeMessage message=null;// 设置为debug模式, 可以查看详细的发送 log
        if(result==1){
        // 3. 创建一封邮件
    ...
    public static MimeMessage createMimeMessage0(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "珠海人才库", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "企业用户", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("企业账号注册验证结果", "UTF-8");

        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("你好, 你的注册失败了哦。请尝试重新验证或联系管理员进行申述。", "text/html;charset=UTF-8");
    ...
    public static MimeMessage createMimeMessage1(Einformation einformation,Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent( einformation.getName()+"你好,恭喜您，您在珠海人才库的注册申请已经通过<br>你的登录账号为："+einformation.getMailbox()+"<br>您的密码为："+einformation.getPassword()+"|||请妥善保存。<br>请点击下面的链接开启你的招聘之旅。。。<br> <a href=''>点击我进去珠海人才库</a>", "text/html;charset=UTF-8");
