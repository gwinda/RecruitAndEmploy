...
function getAjax(positionkey,workkey,moneykey){//点击获取列表的异步操作
	$.ajax({  //异步刷新，可不要
                url :"findjobByThreekey.action",  //后台处理程序          
                type:"post",    //数据发送方式  
                data:"positionkey="+positionkey+"&workkey="+workkey+"&moneykey="+moneykey,
                async:false,  
  				  ...
  				  $("#content2").append("<table border='0' id='listtable'>"+
	  				...
	  				$.each(obj,function(i,value) {  
	                      ...
	                      $("#listtable").append("<tr>"+
							...
							"<td>"+value.idEnterpriseRecruitment+"</td>"+
						"</tr>");    
	                });    
...
$(function () { 
	...
	alink04.click(function () { 
		...
		var moneykey=$("#moneykey").val();
		 ...
		 $("#content2").empty();	
		//alert(positionkey);
		getAjax(positionkey,workkey,moneykey);	
	}); 
...
#content {
	height: 80%; border-top : 1px solid #6cf;
	margin-top: 5px;
	margin-left: 15%;
	margin-right: 15%;
...
<body>
	...
	<div class="position" id="position">
    	...
    	<a herf=""  class="templinkactive" id="">不限</a>     &nbsp; &nbsp; 	
	...
	<div class="work" id="work">
		<!-- 点击大类弹出小分类 -->
		<font size=2 color=gray>职位类别：</font>
		<a herf="#" id="0i" class="templinkactive" onclick="return Findbynolimit('0i')" >不限</a>     &nbsp; &nbsp;  
	...
	<div class="money" id="money">	
		<font size=2 color=gray>薪资水平：
		<a herf=""  class="templinkactive" id="不限">不限</a>       &nbsp; &nbsp; 	
		<a herf="" class="templink" id="1000以下">1000以下</a>     &nbsp; &nbsp; 
		<a herf="" class="templink" id="1001-2000">1001-2000</a>    &nbsp; &nbsp; 
		<a herf="" class="templink" id="2001-4000">2001-4000</a>    &nbsp; &nbsp; 
	...
	<div class="positionbottom"><font size=2 color=black>共找到n个职位满足条件</font></div>
	<div id="content">
		<table border="0">
			<tr>
				<td>招聘名称</td>
